...
​	![argsMeaning](https://github.com/dummychicken/NCUjw/blob/master/photo/argsMeaning.png)

生成课表命令行参数含义如图所示

![image-20210502203116998](https://github.com/dummychicken/NCUjw/blob/master/photo/image-20210502203116998.png)	
...
![image-20210502202158614](https://github.com/dummychicken/NCUjw/blob/master/photo/image-20210502202158614.png)	

**必须建立在当前文件夹下建立 data 文件夹**

初始化命令行之后 生成文件结构为

![image-20210502202456637](https://github.com/dummychicken/NCUjw/blob/master/photo/image-20210502202456637.png)	

其中 TeacherSource.csv 和 StudentSource.csv 记录了教师和学生的状态

运行main.py 文件之后文件结构为

![image-20210502203142426](https://github.com/dummychicken/NCUjw/blob/master/photo/image-20210502203142426.png)	
